CREATE TABLE Users (
    cduser int GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    dtbirth date,
    fgdocument boolean,
    document varchar(20),
    nmuser varchar(100),
...
CREATE TABLE Addresses (
    cdaddress int GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    cdzipcode char(8),
...
CREATE TABLE Countries (
    cdcountry int GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    nmcountry varchar(60),
    sgcountry char(3)
);

CREATE TABLE States (
    cdstate int GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    nmstate varchar(50),
    sgstate char(2),
    cdcountry int
);
...
CREATE TABLE Cities (
    cdcity int GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    nmcity varchar(60),
    cdstate int
);

CREATE TABLE Districts (
    cddistrict int GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    nmdistrict varchar(60),
    cdcity int
);

CREATE TABLE Roles (
    cdrole int GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    nmrole varchar(50)
);
...
CREATE TABLE Contracts (
    cdcontract int GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    dtcreation date,
    dstitle varchar(100),
    cdtemplate int,
    cdproperty int,
...
CREATE TABLE Topics (
    cdtopic int GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    nmtopic varchar(100)
);

CREATE TABLE Clauses (
    cdclause int GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    dstext text,
    cdtopic int
);

CREATE TABLE Variables (
    cdvariable int GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
...
CREATE TABLE Bank_Accounts (
    cdbankaccount int GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    nragency varchar(30),
...
CREATE TABLE Properties (
    cdproperty int GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
...
CREATE TABLE Commissions (
    cdcommission int GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
...
CREATE TABLE Property_Types (
    cdtype int GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    nmtype varchar(30)
);

CREATE TABLE Property_Purposes (
    cdpurpose int GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    nmpurpose varchar(20)
);

CREATE TABLE Property_Status (
    cdstatus int GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    nmstatus varchar(30)
);

CREATE TABLE Occupations (
    cdoccupation int GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    nmoccupation varchar(100)
);

CREATE TABLE Contract_Templates (
    cdtemplate int GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
...
CREATE TABLE Template_Topics (
    cdtopic int,
    cdtemplate int,
    PRIMARY KEY (cdtopic, cdtemplate)
);

CREATE TABLE Indexes (
    cdindex int GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    nmindex varchar(50)
);

CREATE TABLE Index_Rates (
    cdrate int GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    refmonth int,
    refyear int,
    vlrate decimal(10,4),
    cdindex int
...
CREATE TABLE Installments (
    cdinstallment int GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    dtdue date,
    vlbase decimal(12,2),
...
CREATE TABLE Notifications (
    cdnotification int GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    dsmessage text,
    dtsend date,
    fgstatus int,
    tpnotification int,
...
ALTER TABLE Broker_Data ADD CONSTRAINT FK_Broker_Data_1
    FOREIGN KEY (cduser)
...
ALTER TABLE Users ADD CONSTRAINT UK_Users_Document UNIQUE (document);
ALTER TABLE Broker_Data ADD CONSTRAINT UK_Broker_Creci UNIQUE (nrcreci);