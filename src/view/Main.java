...
public class Main {
    ...
    private static void menuRelatorios() {
        ...
        else if (op == 2) relatorioFinanceiroLocacao();
        else if (op == 3) relatorioFinanceiroVenda();
        else if (op == 4) relatorioPartesContrato();
        else if (op == 5) relatorioReajustesDoMes();
        else if (op == 6) propertyDAO.relatorioCompletoImoveis();
    }
...
private static void excluirUsuario() {
    ...
    private static void realizarContrato() {
        ...
        System.out.print("Título do Contrato: "); c.setDstitle(sc.nextLine());
        c.setCdproperty(idP);
        c.setCdindex(1);
        ...
        uc.setCduser(idU);
        System.out.print("ID do Papel (2=Locatário, 4=Comprador): "); uc.setCdrole(Integer.parseInt(sc.nextLine()));
        System.out.print("Percentual de Participação (ex: 100.00): "); uc.setVlparticipation(Double.parseDouble(sc.nextLine()));
        uc.setFgsignaturestatus(SignatureStatus.PENDENTE.getCode()); // Inicia como pendente
        partes.add(uc);

        // Coleta de dados das parcelas
        List<Installments> parcelas = new ArrayList<>();
        System.out.print("Valor da Parcela: "); double v = Double.parseDouble(sc.nextLine());
    ...
    private static void relatorioFinanceiroLocacao() {
        System.out.print("ID Contrato: ");
        int contractId = Integer.parseInt(sc.nextLine());
        reportService.gerarRelatorioFinanceiroLocacao(contractId);
    }

    private static void relatorioFinanceiroVenda() {
        System.out.print("ID Contrato: ");
        int contractId = Integer.parseInt(sc.nextLine());
        reportService.gerarRelatorioFinanceiroVenda(contractId);
    }

    private static void relatorioPartesContrato() {
        System.out.print("ID Contrato: ");
        int contractId = Integer.parseInt(sc.nextLine());
        reportService.gerarRelatorioPartesContrato(contractId);
    }

    private static void relatorioReajustesDoMes() {
